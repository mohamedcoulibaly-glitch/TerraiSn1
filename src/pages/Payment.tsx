...
import { terrainsApi, reservationsApi, paiementsApi } from "@/lib/api";
        ...
        {terrain && (
          <div className="responsive-padding">
            <div className="glass-card p-4 flex items-center gap-3">
              <img src={defaultImages[(terrain.id - 1) % defaultImages.length]} alt={terrain.nom} className="w-16 h-16 rounded-xl object-cover" />
        ...
        <div className="responsive-padding mt-5">
          <div className="glass-card p-4">
            <div className="flex items-center justify-between">
              ...
              <span className="font-display font-bold text-xl sm:text-2xl text-primary">{montant.toLocaleString()} CFA</span>
            </div>
          </div>
        </div>
